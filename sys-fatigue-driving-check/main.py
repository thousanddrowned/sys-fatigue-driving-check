...
BASE_PATH='E:\\tired\\sys-fatigue-driving-check'

COVER = BASE_PATH+'/images/ui8.png'
...
class Fatigue_detecting(wx.Frame):
    ...
    def __init__(self, parent, title):
        ...
        # 设置窗口标题的图标
        self.icon = wx.Icon(BASE_PATH+'/images/555.ico', wx.BITMAP_TYPE_ICO)
    ...
    def _learning_face(self, event):
        ...
        self.predictor = dlib.shape_predictor(BASE_PATH+"/model/shape_predictor_68_face_landmarks.dat")
...
class main_app(wx.App):
    ...
    def OnInit(self):
        self.frame = Fatigue_detecting(parent=None, title="基于卷积神经网络的疲劳驾驶检测")
